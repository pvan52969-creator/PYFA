...
VALIDATION_PROMPTS = [
    ...
    ["标签页三·课程组", "组内课程不足 2 门", "轻提示", "课程组须至少包含 2 门组内课程。"],
    ["标签页三·课程组", "须选课程数≥组内课程数", "轻提示", "须选课程数须小于组内课程总数。"],
    ["标签页三·课程组", "未选组内课程", "轻提示", "请至少选择一门组内课程。"],
    ["标签页三·课程组", "全部设为必选", "轻提示", "不能将全部纳入课程设为必选。"],
    ["标签页三·课程组", "必选数超过须选数", "轻提示", "必选课程数量不能超过须选课程数。"],
    ["标签页二·课程", "已入课程组改开课学期", "轻提示", "该课程已纳入课程组，不可修改开课学期；请先在标签页三移除后再调整。执行计划场景提示回方案版本调整。"],
    ["标签页二·课程", "合并课程弹窗无候选", "空列表", "弹窗正常打开，列表显示「暂无符合条件的课程」；不阻断选择操作。"],
    ["标签页二·课程", "合并课程确认未选", "轻提示", "请选择一门课程进行合并。"],
    ["列表·通用", "筛选未点查询", "—", "学院/专业等筛选须点击「查询」后生效。"],
]
