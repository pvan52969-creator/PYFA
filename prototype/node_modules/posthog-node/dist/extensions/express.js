...
function posthogErrorHandler(posthog) {
    return (error, req, res, next)=>{
        ...
        posthog.addPendingPromise(index_js_default().buildEventMessage(posthog.getErrorPropertiesBuilder(), error, hint, contextData.distinctId, additionalProperties).then((msg)=>{
            posthog.capture(msg);
        }));
        next(error);
    };
